wget 'http://router.houzi-blog.top:3090/kp.dat' -O files/usr/share/koolproxy/data/rules/kp.dat
wget 'http://router.houzi-blog.top:3090/koolproxy.txt' -O files/usr/share/koolproxy/data/rules/koolproxy.txt
wget 'http://router.houzi-blog.top:3090/daily.txt' -O files/usr/share/koolproxy/data/rules/daily.txt
